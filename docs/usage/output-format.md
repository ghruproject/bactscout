...
| `species_abundance` | String | Semicolon-separated Sylph taxonomic abundances (%) for reported species
...
| `expected_genome_size` | Float | Expected genome size derived from `bactscout/config/filtered_metrics.csv` when available |
