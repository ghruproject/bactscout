...
def run_one_sample(
    ...
    try:
        ...
        if len(species) == 1:
            ...
            expected_genome_size, gc_lower, gc_upper = get_expected_genome_size(
                species, config
            )
            ...
            final_results["species_message"] = (
                "Multiple or no species detected, skipping MLST and genome size estimation."
            )
        ...
        return {"status": "failed", "sample_id": sample_id, "error": str(e)}
